...
return [
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_themes,write_themes,read_orders,read_customers,read_all_orders,read_customer_payment_methods,write_own_subscription_contracts'),
